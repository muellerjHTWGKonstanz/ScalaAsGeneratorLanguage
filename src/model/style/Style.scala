...
import model.style.color._
import model.style.gradient.{GradientColorArea, Gradient, GradientAlignment}
import parser.{Cache, CommonParserMethods}
import parser._

sealed class Style private (val name: String = "noName",
